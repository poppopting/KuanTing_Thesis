...
################# SVD ###########################
weight_decay= 0.0004
model_svd = pickle.load(open('models\model_svd_ml1m_f%d.pkl'%dim, 'rb'))
...
################# SVDpp ###########################
weight_decay= 0.0004
model_svdpp = pickle.load(open('models\model_svdpp_ml1m_f%d.pkl'%dim, 'rb'))
...
reg_dict = {'reg_bu': 0.001,
            ...
            'reg_t': 0.001,
            'reg_beta': 0.001}
model_ordmm = pickle.load(open('models\model_ordmm_ml1m_f%d.pkl'%dim, 'rb'))
...
reg_dict = {'reg_bu': 0.001,
            ...
            'reg_t': 0.001,
            'reg_beta': 0.001}
model_ord = pickle.load(open('models\model_ord_ml1m_f%d.pkl'%dim, 'rb'))
...
gradient_df.to_csv('tables\ML_1m_grad_f%d(table9).csv'%dim, index=False, float_format='%.6f')
